  ...
  useEffect(() => {
    ...
    const fsSource = `
      ...
      void main() {
        ...
        color = vec3(0.42, 0.18, 0.82);
        color = mix(color, vec3(0.55, 0.22, 0.96), 0.32 + 0.16 * sin(2.0 * u_scroll_progress + 1.2));
        color += vec3(0.20, 0.0, 0.55) * sin(2.0 * u_scroll_progress + 1.5);
        color = color * noise;
